...
namespace DOOP\Modules\Commands;

use Illuminate\Support\Str;
use DOOP\Modules\Support\Migrations\NameParser;
use DOOP\Modules\Support\Migrations\SchemaParser;
use DOOP\Modules\Support\Stub;
use DOOP\Modules\Traits\ModuleCommandTrait;
